...
namespace Octokit
{
    ...
    public class IssueCommentsClient : ApiClient, IIssueCommentsClient
    {
        ...
        public Task<IReadOnlyList<IssueComment>> GetAllForRepository(string owner, string name)
        {
            ...
            return GetAllForRepository(owner, name, new IssueCommentRequest());
        }
        ...
        {
            return GetAllForRepository(repositoryId, new IssueCommentRequest());
        }
        ...
        /// <param name="owner">The owner of the repository</param>
        /// <param name="name">The name of the repository</param>
        /// <param name="request">Used to filter and sort the list of comments returned</param>
